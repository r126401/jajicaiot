...
CAMINO="/trastero/dispositivosIot/firmware/iotCronoTemp/"
NOMBRE="newVersion"

DIR_LAST_VERSION="/trastero/dispositivosIot/lastVersion/iotCronoTemp"

ifeq ($(APP),1)

install:
	python /opt/esp/ESP8266_RTOS_SDK/components/esptool_py/esptool/esptool.py --port /dev/ttyUSB0 --baud 115200 write_flash 0x01000 bin/upgrade/$(BIN_NAME).bin
	
else

install:
	python /opt/esp/ESP8266_RTOS_SDK/components/esptool_py/esptool/esptool.py --port /dev/ttyUSB0 --baud 115200 write_flash 0x81000 bin/upgrade/$(BIN_NAME).bin
endif
