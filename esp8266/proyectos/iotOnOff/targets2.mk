...
copiar:
	cp bin/upgrade/user1.4096.new.4.bin /trastero/dispositivosIot/firmware/iotOnOff/newVersion1-$(SW_VERSION).bin
	cp bin/upgrade/user2.4096.new.4.bin /trastero/dispositivosIot/firmware/iotOnOff/newVersion2-$(SW_VERSION).bin
