 ...
 */
#define SEGMENTO_USUARIO 0XFC //0X7C
/**
...
/**
 * Funcion definida aqui pero para implementacion en el fichero de la aplicacion.
 * Añade las configuraciones al json propias de la aplicacion.
 * @param nodo es el nodo json raiz de la aplicacion.
 * @param datosApp datos de la aplicacion.
 * @return la estructura json para devolver al usuario.
 */
