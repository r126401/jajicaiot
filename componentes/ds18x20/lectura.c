...
#else
static const gpio_num_t SENSOR_GPIO = CONFIG_GPIO_PIN_DS18B20;
#endif
*/
static const gpio_num_t SENSOR_GPIO = CONFIG_GPIO_PIN_DS18B20;
...
static const char *TAG = "LECTURA DS18B20";
...
*/
esp_err_t lectura_temperatura_ds18x20(float *temp_c) {
    ...
    // Every RESCAN_INTERVAL samples, check to see if the sensors connected
    // to our bus have changed.
    ESP_LOGI(TAG, "SENSOR DE LECTURA %d", SENSOR_GPIO);
    sensor_count = ds18x20_scan_devices(SENSOR_GPIO, addrs, MAX_SENSORS);
